...
TypeRegistry.prototype._buildSchemasFrom = function (definitionObj) {
    ...
    for (var name in definitionObj) {
      ...
      if (nameLowerCase in this._loopbackTypeMap) {
        ...
        if (!defs[loopbackTypeName]) {
          const definition = this._definitions[nameLowerCase];
          if (!definition.type && definition.properties) {
            definition.type = 'object';
          }
          defs[loopbackTypeName] = definition;
        }
      } else {
...
TypeRegistry.prototype.getSchemas = function () {
  var defs = this._buildSchemasFrom(this._referenced);
...
TypeRegistry.prototype.getAllDefinitions = function () {
  return this._buildSchemasFrom(this._definitions);
};
